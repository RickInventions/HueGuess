      ...
      <div className="space-y-2">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-11 pr-12 py-3 rounded-button bg-surface-alt border border-border text-deep text-center text-base sm:text-lg tracking-[0.2em] sm:tracking-[0.25em] font-mono placeholder:text-muted/30 focus:outline-none focus:shadow-glow-primary transition-shadow"
          />
          <button
            type="button"
            onClick={handlePaste}
